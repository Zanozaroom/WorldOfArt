...
class CustomCallAdapter<S : Any, E : Any>(
    private val successType: Type,
    private val errorBodyConverter: Converter<ResponseBody, E>
) : CallAdapter<S, Call<CustomNetworkResponse<S, E>>> {
    /**
    ...
    `</pre> *
     */
    override fun adapt(call: Call<S>): Call<CustomNetworkResponse<S, E>>  {
        return CustomNetworkCall(call, errorBodyConverter)
    }
}